...
> A Launch configuration was also created
...
> I needed to create a LaunchConfiguration and an AutoScalingGroup
...
> NO the instance did not change
...
> The instance was replaced with the new size
